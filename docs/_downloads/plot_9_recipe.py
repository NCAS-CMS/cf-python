...
# %%
# 9. Create grids for PM2.5 and temperature bins using `numpy.meshgrid <https://numpy.org/doc/stable/reference/generated/numpy.meshgrid.html>`_:
temp_grid, pm25_grid = np.meshgrid(temp_bin_centers, pm25_bin_centers)

# %%
# 10. Plot the joint histogram using `matplotlib.pyplot.pcolormesh <http://matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.pcolormesh.html>`_:
