...
.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_gallery_plot_2_recipe.py>`
        to download the full example code

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery_plot_2_recipe.py:
...
.. image-sg:: /auto_gallery/images/sphx_glr_plot_2_recipe_001.png
   :alt: Global Average Temperature Anomaly (1901-2021)
   :srcset: /auto_gallery/images/sphx_glr_plot_2_recipe_001.png
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  43.342 seconds)


.. _sphx_glr_download_auto_gallery_plot_2_recipe.py:
