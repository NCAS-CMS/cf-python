...
* `pyfive <https://pypi.org/project/pyfive>`_, version 1.1.1 or newer.
...
* `cfdm <https://pypi.org/project/cfdm/>`_, version 1.13.2.0 or up to,
...
* `healpix <https://pypi.org/project/healpix>`_, version 2025.1 or
  ...
  datasets, but is needed for particular manipulations with
