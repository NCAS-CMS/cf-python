...
|                          | .. code-block:: python                                                                                                                                                          |
|                          |                                                                                                                                                                                 |
|                          |       >>> x = f.constructs('latitude')                                                                                                                                          |
|                          |       >>> x = f.constructs.filter_by_identity('latitude')                                                                                                                       |
|                          |                                                                                                                                                                                 |
|                          | *Select constructs by property:*                                                                                                                                                |
|                          |                                                                                                                                                                                 |
|                          | .. code-block:: python                                                                                                                                                          |
|                          |                                                                                                                                                                                 |
|                          |       >>> d = f.constructs.filter_by_property(units='degrees_east')                                                                                                             |
|                          |       >>> d = f.constructs.filter_by_property(long_name='height', units='m')                                                                                                    |
|                          |                                                                                                                                                                                 |
|                          | *Select cell method constructs by method:*                                                                                                                                      |
|                          |                                                                                                                                                                                 |
|                          | .. code-block:: python                                                                                                                                                          |
|                          |                                                                                                                                                                                 |
|                          |       >>> d = f.constructs.filter_by_method('mean')                                                                                                                             |
|                          |       >>> d = f.constructs.filter_by_method('mean', 'maximum')                                                                                                                  |
|                          |                                                                                                                                                                                 |
