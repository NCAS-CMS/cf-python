    ...
    def create_bounds(
        ...
        :Parameters:
            ...
            flt: array_like scalar, optional
                ...
                *cellsize* parameter, define the fraction of each cell
                which is less than its coordinate value. By default
            ...
            max: data_like scalar, optional
                Limit the created bounds to be no more than this
                number.
            ...
            min: data_like scalar, optional
                Limit the created bounds to be no less than this
                number.
