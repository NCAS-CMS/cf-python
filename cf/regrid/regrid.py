...
_regrid_method_map_inverse = {v: k for k, v in _regrid_method_map.items()}
...
#        # could mislead or confuse for Cartesian regridding in 1D or 3D.
        ...
        regrid_method = _regrid_method_map.get(method)
    ...
    def dstgrid(self):
        """TODO"""
        return self.regridSrc2Dst.dstfield.grid
    ...
    def srcgrid(self):
        """TODO"""
        return self.regridSrc2Dst.srcfield.grid
    ...
    def create_grid(
        ...
        :Parameters:
            ...
            use_bounds: `bool`
                Whether to populate the grid corners with information
                from the bounds or not.

            mask: `numpy.ndarray`, optional
                An optional numpy array of booleans containing the
                grid points to mask. Where the elements of mask are
                True the output grid is masked.
            ...
            cyclic: `bool`, optional
                Whether or not the longitude (if present) is
                cyclic. If None the a check for cyclicity is made from
                the bounds. None by default.
            ...
            coord_order: sequence, optional
                Two tuples one indicating the order of the x and y
                axes for 2D longitude, one for 2D latitude.
    ...
    def create_field(grid, name):
        ...
        :Parameters:
            ...
            name: `str`
                The name to give the `ESMPy` Field.
