...
#        self.assertFalse(cf.TimeDuration(2, 'days') >= cf.Data(0.03, '100'))
        ...
        self.assertTrue(cf.TimeDuration(36, 'calendar_months') / 8 == cf.M(4.5))
        ...
        self.assertTrue(cf.TimeDuration(36, 'calendar_months') // 8.25 == cf.M(4.0))
    ...
    def test_TimeDuration_interval(self):        
        ...
        self.assertTrue(cf.D(5, hour=6).interval(cf.dt(2004, 3, 2, calendar='noleap'), end=True) ==
                        (cf.dt('2004-02-25 00:00:00', calendar='noleap'), cf.dt('2004-03-02 00:00:00', calendar='noleap')))

        self.assertTrue(cf.D(5, hour=6).interval(cf.dt(2004, 3, 2, calendar='360_day'), end=True) ==
                        (cf.dt('2004-02-27 00:00:00',  calendar='360_day'), cf.dt('2004-03-02 00:00:00',  calendar='360_day')))

        self.assertTrue(cf.h(19897.5).interval(cf.dt(1984, 2, 3, 0)) ==
                        (cf.dt('1984-02-03 00:00:00', calendar=None), cf.dt('1986-05-12 01:30:00', calendar=None)))

        self.assertTrue(cf.h(19897.6).interval(cf.dt(1984, 2, 3, 0), end=True) ==
        ...
        for direction in (True, False):
            for x, y in zip(
                    [cf.Y().bounds(cf.dt(1984, 1, 1), direction=direction),
                     ...
                     cf.Y(month=9).bounds(cf.dt(1984, 1, 1), direction=direction),
                     cf.Y(month=9).bounds(cf.dt(1984, 3, 3), direction=direction),
                     cf.Y(month=9).bounds(cf.dt(1984, 9, 20), direction=direction),
                     cf.Y(month=9, day=13).bounds(cf.dt(1984, 12, 12), direction=direction),
                 ],
                    [(cf.dt('1984-01-01', calendar='standard'), cf.dt('1985-01-01', calendar='standard')),
                     (cf.dt('1984-01-01', calendar='standard'), cf.dt('1985-01-01', calendar='standard')),
                     (cf.dt('1984-01-01', calendar='standard'), cf.dt('1985-01-01', calendar='standard')),
                     (cf.dt('1983-09-01', calendar='standard'), cf.dt('1984-09-01', calendar='standard')),
                     (cf.dt('1983-09-01', calendar='standard'), cf.dt('1984-09-01', calendar='standard')),
                     (cf.dt('1984-09-01', calendar='standard'), cf.dt('1985-09-01', calendar='standard')),
                     (cf.dt('1984-09-13', calendar='standard'), cf.dt('1985-09-13', calendar='standard')),
                 ]):
                if direction is False:
                    y = y[::-1]
                self.assertTrue(x==y, "{}!={} direction={}".format(x, y, direction))
            ...
            for x, y in zip(
                    [cf.M().bounds(cf.dt(1984, 1, 1), direction=direction),
                     ...
                     cf.M(day=15).bounds(cf.dt(1984, 12, 1), direction=direction),
                     cf.M(day=15).bounds(cf.dt(1984, 12, 3), direction=direction),
                     cf.M(day=15).bounds(cf.dt(1984, 12, 15), direction=direction),
                     cf.M(day=15).bounds(cf.dt(1984, 12, 20), direction=direction),
                 ],
                    [(cf.dt('1984-01-01', calendar='standard'), cf.dt('1984-02-01', calendar='standard')),
                     (cf.dt('1984-12-01', calendar='standard'), cf.dt('1985-01-01', calendar='standard')),
                     (cf.dt('1984-12-01', calendar='standard'), cf.dt('1985-01-01', calendar='standard')),
                     (cf.dt('1984-11-15', calendar='standard'), cf.dt('1984-12-15', calendar='standard')),
                     (cf.dt('1984-11-15', calendar='standard'), cf.dt('1984-12-15', calendar='standard')),
                     (cf.dt('1984-12-15', calendar='standard'), cf.dt('1985-01-15', calendar='standard')),
                     (cf.dt('1984-12-15', calendar='standard'), cf.dt('1985-01-15', calendar='standard')),
                 ]):
                if direction is False:
                    y = y[::-1]
            ...
            for x, y in zip(
                    [cf.D().bounds(cf.dt(1984, 1, 1), direction=direction),
                     ...
                     cf.D(hour=15).bounds(cf.dt(1984, 12, 1), direction=direction),
                     cf.D(hour=15).bounds(cf.dt(1984, 12, 1, 12), direction=direction),
                     cf.D(hour=15).bounds(cf.dt(1984, 12, 1, 15), direction=direction),
                     cf.D(hour=15).bounds(cf.dt(1984, 12, 1, 20), direction=direction),
                 ],
                    [(cf.dt('1984-01-01', calendar='gregorian'), cf.dt('1984-01-02', calendar='gregorian')),
                     (cf.dt('1984-12-03', calendar='gregorian'), cf.dt('1984-12-04', calendar='gregorian')),
                     (cf.dt('1984-11-30 15:00', calendar='gregorian'), cf.dt('1984-12-01 15:00', calendar='gregorian')),
                     (cf.dt('1984-11-30 15:00', calendar='gregorian'), cf.dt('1984-12-01 15:00', calendar='gregorian')),
                     (cf.dt('1984-12-01 15:00', calendar='gregorian'), cf.dt('1984-12-02 15:00', calendar='gregorian')),
                     (cf.dt('1984-12-01 15:00', calendar='gregorian'), cf.dt('1984-12-02 15:00', calendar='gregorian')),
                 ]):
                if direction is False:
                    y = y[::-1]
    ...
    def test_TimeDuration_arithmetic(self):
        ...
        self.assertTrue(cf.M() + datetime.datetime(2000, 1, 1) == cf.dt(2000, 2, 1))
        self.assertTrue(datetime.datetime(2000, 1, 1) + cf.M() == cf.dt(2000, 2, 1))
        self.assertTrue(datetime.datetime(2000, 1, 1) - cf.M() == cf.dt(1999, 12, 1))
    ...
    def test_Timeduration__days_in_month(self):
        ...
        self.assertTrue(cf.TimeDuration.days_in_month(1900, 2, calendar='360_day') == 30)
        self.assertTrue(cf.TimeDuration.days_in_month(1999, 2, calendar='360_day') == 30)
        self.assertTrue(cf.TimeDuration.days_in_month(2000, 2, calendar='360_day') == 30)
        self.assertTrue(cf.TimeDuration.days_in_month(2004, 2, calendar='360_day') == 30)
        self.assertTrue(cf.TimeDuration.days_in_month(1900, 2, calendar='noleap') == 28)
        self.assertTrue(cf.TimeDuration.days_in_month(1999, 2, calendar='noleap') == 28)
        self.assertTrue(cf.TimeDuration.days_in_month(2000, 2, calendar='noleap') == 28)
        self.assertTrue(cf.TimeDuration.days_in_month(2004, 2, calendar='noleap') == 28)
        self.assertTrue(cf.TimeDuration.days_in_month(1900, 2, calendar='366_day') == 29)
        self.assertTrue(cf.TimeDuration.days_in_month(1999, 2, calendar='366_day') == 29)
